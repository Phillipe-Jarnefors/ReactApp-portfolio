    ...
    <section className="home-wrapper">
      ...
      <main className="grid grid-cols-3 gap-6 sm:gap-10 md:gap-16 lg:gap-[6rem] xl:gap-0">
       <div className="col-span-2 mt-7">
        <p className="text-standard text-font sm:py-4 xl:py-14">This is a showcase app, featuring the projects I've worked on during my studies</p>
        <article className="flex gap-3 mt-7">
          ...
          <section className="sm:pl-4 xl:pl-8 ">
            ...
            <button className="2xl:animate-bounce text-button rounded-md hover:bg-primary hover:text-abstract text-font outline px-5 lg:px-8 py-2 lg:py-5 mt-6 mb-1 md:mt-12">Reach out &gt;</button>
          </section>
        </article>
       </div>
       {slowVisible && <section className="container animate-fade-in xl:z-10 xl:h-full xl:w-1/2 ml-auto mb-40 grid grid-cols-4 grid-rows-layout col-span-1 gap-2 mt-3 ">
